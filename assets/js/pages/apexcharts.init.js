...
columnChartColors && (options = {
    ...
    series: [{
        name: "At work",
        data: [150, 200, 250, 50, 100, 150, 120, 250, 200, 150]
    }, {
        name: "Task Spent",
        data: [50, 150, 100, 20, 50, 100, 50, 150, 150, 100]
    
    }],
    colors: columnChartColors,
    xaxis: {
        categories: ["2023-05-11", "2023-05-12", "2023-05-13", "2023-05-14", "2023-05-15", "2023-05-16", "2023-05-17", "2023-05-18", "2023-05-19", "2023-05-20"]
    },
    yaxis: {
        title: {
            // text: "$ (thousands)",
...
var columnChartColors = getChartColorsArray("column_chart1");
columnChartColors && (options = {
    chart: {
        height: 240,
        type: "bar",
